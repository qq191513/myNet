...
def main(args):
    with tf.Graph().as_default(), tf.device('/gpu:0'):
        ...
        create_inputs = cfg.get_create_inputs(dataset_name, is_train=True, epochs=cfg.epoch)
        ...
        for step in range(start_epoch * num_batches_per_epoch ,cfg.epoch * num_batches_per_epoch + 1):
