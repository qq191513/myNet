...
class ConvNet():
    def __init__(self, n_channel=3, n_classes=10, image_size=24, n_layers=20):
        ...
        self.logits_4 = self.inference(images=basic_conv, scope_name='net_4')
        self.logits_5 = self.inference(images=basic_conv, scope_name='net_5')
    ...
    def inference(self, images,scope_name):
