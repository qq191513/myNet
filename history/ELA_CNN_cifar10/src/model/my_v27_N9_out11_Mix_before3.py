...
class ConvNet():
    def __init__(self, n_channel=3, n_classes=10, image_size=24, n_layers=44,is_training =True,setting=None):
        ...
        self.debug_mode = setting.debug_mode
        self.only_test_small_part_dataset = setting.only_test_small_part_dataset
        self.is_son3 = False
        ...
        logits_list=[
                    ...
                    self.logits_3,self.logits_3_1,self.logits_3_2,
                    ]
    ...
    def get_all_acc_list(self,test_images,test_labels,n_test,batch_size,is_train =True):
        ...
        n_test =n_test - 1
        start_pos = 0
        if self.only_test_small_part_dataset:
        ...
        for i in range(start_pos, n_test, batch_size):
            ...
            [labels_array,
             ...
             logits_3, logits_3_1,logits_3_2,
                ...
                fetches=[self.labels,
                         ...
                         self.accuracy_3, self.accuracy_3_1,self.accuracy_3_2,
                         self.logits_1,self.logits_1_1,self.logits_1_2,self.logits_1_3,
                         self.logits_2,self.logits_2_1,self.logits_2_2,self.logits_2_3,
                         self.logits_3,self.logits_3_1,self.logits_3_2,
                         ],
            ...
            merrge_array = np.concatenate([[predict_1],[predict_1_1],[predict_1_2],[predict_1_3],
                                           ...
                                           [predict_3],[predict_3_1],[predict_3_2],
                                           ], axis=0)
        ...
        return accuracy_1_list,accuracy_1_1_list,accuracy_1_2_list,accuracy_1_3_list, \
               ...
               accuracy_3_list,accuracy_3_1_list,accuracy_3_2_list,\
               acc_decision_batch_hv_dict
    ...
    def train(self, dataloader, backup_path, n_epoch=5,
        ...
        for epoch in range(start_n_epoch, n_epoch+1):
            ...
            if epoch % 5 == 0:
                ...
                message_3_2 = ' net3_2: %.4f\n' % (np.mean(accuracy_3_2_list))
