...
if __name__ =='__main__':
    file_path = 'em-asl-train_acc.txt'
    file_path_1 = 'em-asl_v3-train_acc.txt'
    ...
    # y_datas_dict_3 = get_parameters_list(path = file_path_2 ,re_dict= y_re_dict_3)
    ...
    y_datas_legend_dict['em_asl']="Caps-em Original"
    y_datas_legend_dict['em_v3_asl']="Caps-em improved"
    # y_datas_legend_dict['capsnet_v3_Value']="capsnet_em_v3"


    #标题、x轴、y轴显示信息
    setting_dict = OrderedDict()
    setting_dict['title'] = 'The improved effects of the Caps-em in ASL dataset'
