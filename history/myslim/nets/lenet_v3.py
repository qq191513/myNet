...
def lenet_v3(images, num_classes=10, is_training=False,
  ...
  # end_points = {}
  compression = 1.0
  with tf.variable_scope(scope, 'lenet_v3', [images]):
...
lenet_v3.default_image_size = 28


def lenet_v3_arg_scope(weight_decay=0.0):
...
if __name__ == "__main__":
    ...
    inputs = tf.random_normal([1, lenet_v3.default_image_size, lenet_v3.default_image_size, 3])
    with slim.arg_scope(lenet_v3_arg_scope()):
         logits, end_points= lenet_v3(inputs,10)
