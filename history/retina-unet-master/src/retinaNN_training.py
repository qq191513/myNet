...
#============  Training ==================================
checkpointer = ModelCheckpoint(filepath=name_experiment +'_best_weights.h5', verbose=1, monitor='val_loss', mode='auto', save_best_only=True) #save at each epoch if the validation decreased
...
model.save_weights(name_experiment +'_last_weights.h5', overwrite=True)
#test the model
