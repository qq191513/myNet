...
loss_list, train_precision_list, valid_precision_list = load_log('cifar10-v1.txt')
...
train_precision_list, train_precision_idxs = curve_smooth(train_precision_list, batch_size=100)
