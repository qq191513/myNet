...
class ConvNet():
    ...
    # def generate_layer_get_new_dataflow(self,imgage,hidden_conv,scope_name):
    #     with tf.variable_scope(scope_name):
    #         conv_lists = []
    #         def_image_layer=True
    #
    #
    #
    #
    ...
    def train(self, dataloader, backup_path, n_epoch=5):
        ...
        for epoch in range(0, n_epoch+1):
            ...
            # n_test = n_test - n_test % self.batch_size
            start_pos = 0
            ...
            train_wrong_parament=train_wrong_parament(epoch=epoch, epoch_wrong=0,train_times=5)
            ...
            #                    self.labels: batch_labels,
            #                    self.keep_prob: 1.0})
            #     valid_accuracy += avg_accuracy * batch_i
            #     [avg_accuracy, avg_loss] = self.sess.run(mages.shape[0]
